...
class TextEditorApp:
    ...
    def analizar(self):
        try:
            ...
            messagebox.showinfo("Análisis Exitoso", Resultados)
        except Exception as e:
            messagebox.showinfo("Error", "No se ha ingresado ningún archivo o se produjo un error.")
        ...
        try:
            ...
            for respuesta in respuestas_Operaciones:
                if isinstance(respuesta.operar(None), int) or isinstance(respuesta.operar(None), float) == True:
                    ...
                    if respuesta.ejecutarT() == "color-fondo-nodo":
                    ...
                    if respuesta.ejecutarT() == "color-fuente-nodo":  
                    ...
                    if respuesta.ejecutarT() == "forma-nodo":  
